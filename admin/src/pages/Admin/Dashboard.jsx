...
const Dashboard = () => {
  ...
  //if dashData is present then only return this div
  return dashData && (
    <div className='m-5'>
      ...
      <div className='bg-white'>
        <div className='flex items-center gap-2.5 px-4 py-4 mt-10 round'>
          <img src={assets.list_icon} alt="" /><p className='font-semibold'>Latest Appointments</p>
        </div>
