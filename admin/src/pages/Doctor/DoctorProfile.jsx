    ...
    <div>
        <div className='flex flex-col gap-4 m-5'>
            ...
            <div className='flex-1 border border-stone-100 rounded-lg p-8 py-7 bg-white'>
                ...
                {
                    isEdit
                    ? <button onClick={updateProflie} className='px-4 py-1 border border-primary text-sm rounded-full mt-5 hover:bg-primary hover:text-white transition-all'>save</button>
